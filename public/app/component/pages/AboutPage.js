            ...
            m('div.application-container',
                m('div.not-the-footer-container',
                    ...
                    m('main',
                        m('h3', 'Purpose'),
                        m('p',
                            'This site was created to have a clean, minimal dictionary available for me to use while learning Chinese. I wanted something that would work on my computers and mobile devices, all without distractions.'
                        ),
                        m('h3', 'Thanks'),
                        m('p',
